...
echo "시작: $(date)"
python run_gui_actor.py --max_pixels 1003520
echo "완료: $(date)"
echo ""
...
echo "시작: $(date)"
python run_gui_actor.py --no_early_exit --max_pixels 1003520
echo "완료: $(date)"
echo ""
...
echo "시작: $(date)"
python run_gui_actor.py --max_pixels 3211264
echo "완료: $(date)"
echo ""
...
echo "시작: $(date)"
python run_gui_actor.py --no_early_exit --max_pixels 3211264
echo "완료: $(date)"
echo ""
