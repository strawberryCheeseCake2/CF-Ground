...
# ATTN_IMPL = "flash_attention_2"                      # attention implement "eager" "sdpa" "flash" "efficient"
...

        {
            ...
            "content": [
                ...
                },
                {
                    ...
                    # Answer:?""",
                    "text": f"""You are a GUI agent. You are given a task and your action history, with screenshots. You need to perform the next action to complete the task. \n\n## Output Format\n\nAction: ...\n\n\n## Action Space\nclick(point='<point>x1 y1</point>'')\n\n## User Instruction
{instruction}""",
                    "payload": instruction
                }
            ],
...
def inference(converstaion):
    ...
    # outputs = model.generate(prompts_data)
    # print(outputs)
    # exit()
...
def run_model(image, instruction):
    ...
    try:
        ...
        coord = convert_point_to_coordinates(response)
