...
# os.environ["CUDA_VISIBLE_DEVICES"]= "1,2,3"  # Set the GPUs 2 and 3 to use
...
args.save_dir = "./attn_output/q50_r20_thumb_s2_agg20_try2/eval_res" # resize
...
for task in tasks:
    ...
    for j, item in tqdm(enumerate(screenspot_data)):
        ...
        for crop_id in s1_top_q_crop_ids:
            ...
            s1_selected_crop["img"].save(f"{seg_save_base_dir}/{filename_wo_ext}/{inst_dir_name}/s2/crop{crop_id}/selected_crop_from_s1.png")
            ...
            for detail_crop in s2_detail_crops:
                ...
                #forward 돌릴 crop list에 추가
                s2_crop_list.append(detail_crop)
            ...
            s2_top_q_crop_ids, s2_top_q_bboxes, s2_raw_res_dict, s2_crop_list = run_stage(
              msgs=msgs, crop_list=s2_crop_list, top_q=0.3, drop_indices=[0, crop_id], 
